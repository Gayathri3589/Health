    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <p class="infopost">&nbsp;</p>
          <img src="images/IMG_8996.gif" width="207" height="219" alt="" class="fl" />
          <form id="form1" name="form1" method="post" action="Encryption">
            <table width="371" height="219" border="0">
              <tr>
                <td height="84" colspan="2"><div align="center" class="style14">  MEDICAL VALUES </div></td>
              </tr>
              <tr>
                <td width="172"><span class="style25">Pulse</span></td>
                <td width="189"><label>
                  <input name="sensor1" type="text" id="sensor1" value="<%=session.getAttribute("content")%>" />
                </label></td>
              </tr>
              <tr>
                <td><span class="style25">Temperature </span></td>
                <td><label>
                  <input name="sensor2" type="text" id="sensor2" value="<%=session.getAttribute("content1")%>" />
                </label></td>
              </tr>
              <tr>
                ...
                <td><label>
                  <input name="sensor3" type="text" id="sensor3" value="<%=session.getAttribute("content2")%>" />
                </label></td>
              </tr>
              <tr>
