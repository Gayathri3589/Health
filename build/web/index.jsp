    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="RetrieveData">
            <table width="371" height="219" border="0">
              <tr>
                <td width="361" height="84"><div align="center" class="style14"> <a href="patientregister.jsp">Patient Registration </a></div></td>
              </tr>
              <tr>
                <td><div align="center">
                  <label></label>
                  <span class="style14"><a href="patientlogin.jsp">Patient Login </a></span></div></td>
              </tr>
            </table>
          </form>
