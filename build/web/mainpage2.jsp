          ...
          <form id="form1" name="form1" method="post" action="Decryption">
            <table width="371" height="219" border="0">
              ...
              <tr>
                ...
                <td width="189"><label>
                  <input name="sensor1" type="text" id="sensor1" value="<%=session.getAttribute("d1")%>" />
                </label></td>
              </tr>
              <tr>
                <td><span class="style25">Temperature </span></td>
                <td><label>
                  <input name="sensor2" type="text" id="sensor2" value="<%=session.getAttribute("d2")%>" />
                </label></td>
              </tr>
              <tr>
                ...
                <td><label>
                  <input name="sensor3" type="text" id="sensor3" value="<%=session.getAttribute("d3")%>" />
                </label></td>
              </tr>
              <tr>
