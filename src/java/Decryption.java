   ...
   public class Decryption extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException,ServletException {
       ...
       // System.out.println("Original message:"+originalMessage);
        ...
        String d1 = decrypt(s1, privateKey);
String d2 = decrypt(s2, privateKey);
String d3 = decrypt(s3, privateKey);
	
         sn.setAttribute("d1",d1);
            sn.setAttribute("d2",d2);
            sn.setAttribute("d3",d3);
      
            rd=req.getRequestDispatcher("mainpage2.jsp");
